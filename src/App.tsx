...
function App() {
  ...
  <div className="container mx-auto flex items-center justify-between">
    ...
    <div className="hidden md:flex space-x-4 text-md font-bold mr-20">
      <button className="bg-white text-blue-600 border border-blue-600 px-4 py-2 rounded-full hover:bg-blue-200">
        Contact Us
      </button>
      <button className="bg-blue-600 text-white px-4 py-2 rounded-full hover:bg-gray-700">
        Book A Demo
      </button>
    </div>
      ...
      <div className="flex flex-col lg:flex-row p-4 lg:p-20 justify-center items-center bg-gray-100 mx-auto">
        ...
        <div className="w-full lg:w-2/3 p-4 justify-center lg:justify-start">
          ...
          <div className="mt-6 lg:mt-10">
            <button className="bg-blue-600 text-white px-4 lg:px-8 py-2 rounded-full hover:bg-gray-700 mr-2 lg:mr-4">
              Start Your Free Trial Today!
            </button>
            <button className="bg-white text-blue-600 border border-blue-600 px-4 lg:px-7 mt-3 py-2 rounded-full hover:bg-blue-200">
              Watch Video
            </button>
          </div>
        </div>
